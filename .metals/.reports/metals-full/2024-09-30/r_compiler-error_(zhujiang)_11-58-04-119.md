...
class FakeCHISlave(implicit p : Parameters) extends Module {
  ...
  val selSendDBIDBuf = PriorityEncoder(buf)
    ...
    case(w, i) =>
      switch(w.state){
        ...
        is(DDRState.SendDBIDResp){
          val hit = io.rxrsp.fire & io.rxrsp.bits.Opcode === RSP.CompDBIDResp & sel
        }
      }
  }
...
```
scala.reflect.internal.Definitions$DefinitionsClass.fatalMissingSymbol(Definitions.scala:1404)
	scala.reflect.internal.Definitions$DefinitionsClass.miss$1(Definitions.scala:1457)
	scala.reflect.internal.Definitions$DefinitionsClass.$anonfun$getMemberMethod$2(Definitions.scala:1459)
	scala.reflect.internal.Definitions$DefinitionsClass.getMemberMethod(Definitions.scala:1459)
	scala.reflect.internal.Definitions$DefinitionsClass.Any_getClass$lzycompute(Definitions.scala:1166)
	scala.reflect.internal.Definitions$DefinitionsClass.Any_getClass(Definitions.scala:1166)
	scala.reflect.internal.Definitions$DefinitionsClass.syntheticCoreMethods$lzycompute(Definitions.scala:1571)
