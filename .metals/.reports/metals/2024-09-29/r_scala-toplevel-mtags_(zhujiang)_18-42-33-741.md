error id: file://<WORKSPACE>/src/main/scala/xijiang/bridge/parameter/Opcode.scala:[7004..7007) in Input.VirtualFile("file://<WORKSPACE>/src/main/scala/xijiang/bridge/parameter/Opcode.scala", "package xijiang.bridge.parameter
...
file://<WORKSPACE>/src/main/scala/xijiang/bridge/parameter/Opcode.scala:216: error: expected identifier; obtained def
    def widthCheck(opcode: UInt): Unit = { require (opcode.getWidth >= width) }
    ^
#### Short summary: 
