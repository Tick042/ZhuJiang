error id: file://<WORKSPACE>/src/main/scala/xijiang/bridge/parameter/Opcode.scala:[7047..7050) in Input.VirtualFile("file://<WORKSPACE>/src/main/scala/xijiang/bridge/parameter/Opcode.scala", "package xijiang.bridge.parameter
...
")
file://<WORKSPACE>/src/main/scala/xijiang/bridge/parameter/Opcode.scala
file://<WORKSPACE>/src/main/scala/xijiang/bridge/parameter/Opcode.scala:217: error: expected identifier; obtained def
    def widthCheck(opcode: UInt): Unit = { require (opcode.getWidth >= width) }
    ^
#### Short summary: 
